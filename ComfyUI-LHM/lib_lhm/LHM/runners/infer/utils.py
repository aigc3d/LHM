...
def predict_motion_seqs_from_images(image_folder: str, save_root, fps=6):
    os.system("python ./custom_nodes/ComfyUI-LHM/lib_lhm/engine/pose_estimation/video2motion.py --video_path {} --output_path {}".format(image_folder, save_root))
    return os.path.join(save_root, image_folder.split("/")[-1].split(".")[0], 'smplx_params'), image_folder
