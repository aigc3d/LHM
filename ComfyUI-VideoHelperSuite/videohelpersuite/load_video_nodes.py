...
def load_video(meta_batch=None, unique_id=None, memory_limit_mb=None, vae=None,
    ...
    if vae is None:
        return (images, len(images), audio, video_info, kwargs['video'])
    else:
        return ({"samples": images}, len(images), audio, video_info, kwargs['video'])
...
class LoadVideoUpload:
    ...
    RETURN_NAMES = ("IMAGE", "frame_count", "audio", "video_info", "video_path")
